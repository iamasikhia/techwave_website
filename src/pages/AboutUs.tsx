...
const processSteps = [
  ...
  },
  {
    image: Strategize,
    title: "Learn",
    description: "Access structured technology enablement programmes designed to give you practical, business-ready digital skills.",
    number: "02",
  },
  {
    image: Implement,
          ...
          <div className="relative max-w-6xl mx-auto px-6 py-16 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2 text-white">
              ...
              <p className="text-base text-gray-400 leading-relaxed max-w-lg">
                ...
                potential of African entrepreneurs by giving them technology enablement, a powerful
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-10">
              ...
              <div className="flex-1">
                ...
                <p className="text-lg md:text-2xl lg:text-3xl font-medium text-gray-800 leading-relaxed mb-6">
